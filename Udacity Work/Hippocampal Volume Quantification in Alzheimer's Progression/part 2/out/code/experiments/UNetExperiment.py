...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: The first dimension of prediction (8) represents the batch size. 
            # The second (3) represents the class probability. 
            # The third and fourth (64, 64) represent those of the 2D slices.
