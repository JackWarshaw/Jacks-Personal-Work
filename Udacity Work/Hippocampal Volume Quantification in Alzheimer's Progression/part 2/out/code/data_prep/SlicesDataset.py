...
class SlicesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        vox_img = self.data[slc[0]]["image"][slc[1]]
        vox_lbl = self.data[slc[0]]["seg"][slc[1]]
        
        vox_img = vox_img[None, :]
        vox_lbl = vox_lbl[None, :]
        sample["image"] = torch.from_numpy(vox_img).cuda()
        sample["seg"] = torch.from_numpy(vox_lbl).cuda()
