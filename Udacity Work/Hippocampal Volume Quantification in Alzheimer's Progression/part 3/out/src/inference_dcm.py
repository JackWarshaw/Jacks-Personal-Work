...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    draw.multiline_text((10, 90), text, 
...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"../../out_section_2/results/model.pth")
    ...
    report_save_path = r"../reports/report_2.dcm"
    ...
    os_command("storescu 127.0.0.1 4242 -v -aec HIPPOAI ../reports/report.dcm")
